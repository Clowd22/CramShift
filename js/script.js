const WebApp_URL = "https://script.google.com/macros/s/AKfycbx_E8ODTuDEz_pjyCroWjCxRUiSACV87QgicNClQz6CW3imXIIcdlo5RVdfdgsqHIR9Gw/exec"
...
generateCalendar();
document.getElementById('monthSelector').addEventListener('change', generateCalendar);const WebApp_URL = "https://script.google.com/macros/s/AKfycbx_E8ODTuDEz_pjyCroWjCxRUiSACV87QgicNClQz6CW3imXIIcdlo5RVdfdgsqHIR9Gw/exec"
const SHIFTS_MAIN = ['A', 'B', 'C', 'D'];
const SHIFTS_EXTRA = ['X', 'Y', 'Z'];
let showXYZ = false;
